...
function setLocale(locale) {
    ...
    if(location.pathname.indexOf("/blog/") >= 0 || location.pathname.indexOf("/faq/") >= 0 || location.pathname.indexOf("/howto/") >= 0 || location.pathname === "/help/apple_silicon_compatibility.html") {
        return;
    }
